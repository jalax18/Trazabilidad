...
namespace Trazabilidad.Backend.Controllers
{
    public class GarumsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "GarumId,VerGarum")] Garum garum)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "GarumId,VerGarum")] Garum garum)
        {
            if (ModelState.IsValid)
            {
